module.exports = [
	{
		...
		id: "FRS001",
		set: ["00001"],
		name: "Duras's Bird-of-Prey",
		image: "https://i.imgur.com/EOZP59R.png",
		class: "22nd Century Bird-of-Prey",
		...
		shields: 3,
		cost: 14,
		text: "<b>ATTACK:</b> When attacking a <img src='img/text/faction-federation.png' width='20' height='20' title='Federation'> ship, re-roll 1 attack die.",
		unique: true,
		alliance: false,
		factions: ["klingon"],
		intercept: {
	...
	},
	{
		...
		shields: 2,
		cost: 8,
		text: "<b>FREE ACTION:</b> Perform a [scan] Action as a free action. <hr> When your ship is destroyed, before removing it from the play area choose up to 2 [crew_text] upgrades and tansfer them to a friendly ship within range. [crew_text] upgrades may exceed ship restrictions.",
		unique: true,
		alliance: false,
		factions: ["klingon"],
		intercept: {
	...
	},
	{
		...
		shields: 2,
		cost: 22,
		text: "<b>ATTACK:</b> You may fire your primar weapon in any direction. <hr> <b>MODIFY ATTACK DICE STEP:</b> If you are not in the <img src='img/text/forward-arc.png' width='20' height='20'> of the target ship, you may force the defending ship to re-roll 1 defense die of your choice.",
		unique: true,
		alliance: false,
		factions: ["klingon"],
		intercept: {
	...
	},
	{
		...
		shields: 3,
		cost: 20,
		text: "<b>ATTACK PHASE:</b> You may fire your primary weapon in any direction.",
		unique: false,
		alliance: false,
		factions: ["klingon"],
		intercept: {
	...
	},
	{
		...
		shields: 3,
		cost: 13,
		text: "<b>ATTACK PHASE:</b> When attacking at Range 1, disable 1 active shield token on the target ship (if possible).",
		unique: true,
		alliance: false,
		factions: ["klingon"],
		intercept: {
	...
	},
	{
		...
		shields: 2,
		cost: 22,
		text: "<b>ACTIVATION PHASE:</b> Prior to revealing your maneuver dial, make a maneuver with a speed of 1 or 2. <hr> <b>ATTACK:</b> You may fire your primary weapon in any direction.",
		unique: true,
		alliance: false,
		factions: ["klingon"],
		intercept: {
	...
	},
	{
		...
		shields: 3,
		cost: 20,
		text: "<b>ACTION:</b> Place 4 <img src='img/stuff/effect_time_token.png' width='20' height='16'> Tokens on this card. \n\n Target an oppsoing ship in range 1 with no shields. Steal 1 [crew_text] Updrade of your choice.",
		unique: true,
		alliance: false,
